...
if __name__ == "__main__":
    ...
    level_manager.add_scene_events("start-playing", "start-timer", lambda: pyxel.btnp(pyxel.KEY_RETURN))
    level_manager.add_scene_events("main", "update-resources", lambda: pyxel.btnp(pyxel.KEY_SPACE))
    events = level_manager.scenes_events
    print(events)
